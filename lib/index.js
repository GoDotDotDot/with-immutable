...
import { Iterable, is } from 'immutable'; // eslint-disable-next-line

var ImmutableToJS = function ImmutableToJS(WrappedComponent) {
  return (
    /*#__PURE__*/
    function (_React$Component) {
      ...
      _createClass(ImmutableComponent, [{
        ...
        value: function render() {
          var KEY = 0;
          var VALUE = 1;
          var propsJS = Object.entries(this.props).reduce(function (newProps, wrappedComponentProp) {
            // eslint-disable-next-line
